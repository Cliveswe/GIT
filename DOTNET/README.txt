...
haw, hawaiian
jap, japan
png,PNG (This is an interesting airline with a different logo. http://www.pngair.com.pg/en/)

InvoiceMaker:
The project "InvoiceMaker" is interactive one can change the quantity of each product. Load an Invoice 
from the DemoFiles folder. Changeing the quantity of an item will recalculate the invoice.